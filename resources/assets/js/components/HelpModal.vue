                ...
                <div class="modal-container">
                    ...
                    <div class="modalbody">
                        ...
                        <div class="info-section">
                            ...
                            <p><b>COLOR:#000000</b></p> - Change #000000 to desired color. Changes your map and name color. Colors have to be unique on the map, meaning users, other users and houses can not share colors. Additionally blocked colors: #18424C, #000000, #99d9EA, #FFFFFF.
                            ...
                            <p><b>HOUSE_COLOR:#000000</b></p> - Change #000000 to desired color. Changes your current house's map and name color. Only works if you own the house you're in. Colors have to be unique on the map, meaning users, other users and houses can not share colors. Additionally blocked colors: #18424C, #000000, #99d9EA, #FFFFFF.
